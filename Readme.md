...
🔗 [Открытьдашборд в Yandex DataLens](https://datalens.yandex/dq6soeesp7c8y)

---

# Dashboard TED Talks

Дашборд, посвящённый анализу данных о конференциях **TED**.  
...
- **SQL** — подготовка, очистка данных, агрегация данных
